...
import type { DevEditorConfig } from '@lib/config/types';
 ...
 */
function buildEditorUrl(editor: DevEditorConfig, filePath: string): string {
 ...
 */
function openInEditor(editor: DevEditorConfig, filePath: string): void {
